...
from typing import Any, Dict, List, Optional, cast, Final, final
...
class BuilderConfig(BuilderConfig_BaseClass):
    default_processors: List[DataProcessor_BaseClass] = field(default_factory=lambda: [
...
class Builder:
    ...
    def build(self, data: Any, attrib: Optional[Dict[str, str]] = None, **kwargs) -> ET.Element:
